...
-- ----------------------------
ALTER TABLE "action_verification" ADD CONSTRAINT "action_verification_pkey" PRIMARY KEY ("acve_id");

-- ----------------------------
-- Primary Key structure for table auth_log
-- ----------------------------
ALTER TABLE "auth_log" ADD CONSTRAINT "auth_log_pkey" PRIMARY KEY ("aulo_id");
...
-- ----------------------------
ALTER TABLE "authentication_email" ADD CONSTRAINT "unq_authentication_email_user_id" UNIQUE ("user_id");

-- ----------------------------
-- Primary Key structure for table authentication_email
-- ----------------------------
ALTER TABLE "authentication_email" ADD CONSTRAINT "authentication_email_pkey" PRIMARY KEY ("auem_id");

-- ----------------------------
-- Primary Key structure for table config
-- ----------------------------
ALTER TABLE "config" ADD CONSTRAINT "config_pkey" PRIMARY KEY ("path");

-- ----------------------------
-- Primary Key structure for table geo_city
-- ----------------------------
ALTER TABLE "geo_city" ADD CONSTRAINT "geo_city_pkey" PRIMARY KEY ("geci_id");

-- ----------------------------
-- Primary Key structure for table geo_country
-- ----------------------------
ALTER TABLE "geo_country" ADD CONSTRAINT "geo_country_pkey" PRIMARY KEY ("geco_id");

-- ----------------------------
-- Primary Key structure for table geo_state
-- ----------------------------
ALTER TABLE "geo_state" ADD CONSTRAINT "geo_state_pkey" PRIMARY KEY ("gest_id");

-- ----------------------------
-- Primary Key structure for table geo_state_capital
-- ----------------------------
ALTER TABLE "geo_state_capital" ADD CONSTRAINT "unq_geo_state_capital_gest_id_geci_id" PRIMARY KEY ("gest_id", "geci_id");

-- ----------------------------
-- Uniques structure for table geo_zip_code
-- ----------------------------
ALTER TABLE "geo_zip_code" ADD CONSTRAINT "unq_geo_zip_code_zip_code" UNIQUE ("zip_code");

-- ----------------------------
-- Primary Key structure for table geo_zip_code
-- ----------------------------
ALTER TABLE "geo_zip_code" ADD CONSTRAINT "geo_zip_code_pkey" PRIMARY KEY ("gezi_id");

-- ----------------------------
-- Uniques structure for table manager
-- ----------------------------
ALTER TABLE "manager" ADD CONSTRAINT "unq_manager_user_id" UNIQUE ("user_id");

-- ----------------------------
-- Primary Key structure for table manager
-- ----------------------------
ALTER TABLE "manager" ADD CONSTRAINT "manager_pkey" PRIMARY KEY ("mana_id");

-- ----------------------------
-- Primary Key structure for table migration
-- ----------------------------
ALTER TABLE "migration" ADD CONSTRAINT "migration_pkey" PRIMARY KEY ("migr_id");

-- ----------------------------
-- Primary Key structure for table notification
-- ----------------------------
ALTER TABLE "notification" ADD CONSTRAINT "notification_pkey" PRIMARY KEY ("noti_id");

-- ----------------------------
-- Primary Key structure for table notification_user
-- ----------------------------
ALTER TABLE "notification_user" ADD CONSTRAINT "notification_user_pkey" PRIMARY KEY ("user_id", "noti_id");

-- ----------------------------
-- Primary Key structure for table one_time_login
-- ----------------------------
ALTER TABLE "one_time_login" ADD CONSTRAINT "one_time_login_pkey" PRIMARY KEY ("otlo_id");
...
-- ----------------------------
ALTER TABLE "action_verification" ADD CONSTRAINT "fk_action_verification_user_1" FOREIGN KEY ("user_id") REFERENCES "user" ("user_id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- ----------------------------
-- Foreign Keys structure for table auth_log
-- ----------------------------
ALTER TABLE "auth_log" ADD CONSTRAINT "fk_auth_log_user_1" FOREIGN KEY ("user_id") REFERENCES "user" ("user_id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- ----------------------------
-- Foreign Keys structure for table authentication_email
-- ----------------------------
ALTER TABLE "authentication_email" ADD CONSTRAINT "fk_authentication_email_user_1" FOREIGN KEY ("user_id") REFERENCES "user" ("user_id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- ----------------------------
-- Foreign Keys structure for table geo_city
-- ----------------------------
ALTER TABLE "geo_city" ADD CONSTRAINT "fk_geo_city_state_gest_id" FOREIGN KEY ("gest_id") REFERENCES "geo_state" ("gest_id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- ----------------------------
-- Foreign Keys structure for table geo_state
-- ----------------------------
ALTER TABLE "geo_state" ADD CONSTRAINT "fk_geo_state_geo_country_geco_id" FOREIGN KEY ("geco_id") REFERENCES "geo_country" ("geco_id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- ----------------------------
-- Foreign Keys structure for table geo_state_capital
-- ----------------------------
ALTER TABLE "geo_state_capital" ADD CONSTRAINT "fk_geo_state_capital_geci_id" FOREIGN KEY ("geci_id") REFERENCES "geo_city" ("geci_id") ON DELETE NO ACTION ON UPDATE NO ACTION;
ALTER TABLE "geo_state_capital" ADD CONSTRAINT "fk_geo_state_capital_gest_id" FOREIGN KEY ("gest_id") REFERENCES "geo_state" ("gest_id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- ----------------------------
-- Foreign Keys structure for table geo_zip_code
-- ----------------------------
ALTER TABLE "geo_zip_code" ADD CONSTRAINT "fk_geo_zip_code_geo_city_geci_id" FOREIGN KEY ("geci_id") REFERENCES "geo_city" ("geci_id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- ----------------------------
-- Foreign Keys structure for table manager
-- ----------------------------
ALTER TABLE "manager" ADD CONSTRAINT "fk_manager_user_1" FOREIGN KEY ("user_id") REFERENCES "user" ("user_id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- ----------------------------
-- Foreign Keys structure for table notification_user
-- ----------------------------
ALTER TABLE "notification_user" ADD CONSTRAINT "fk_notification_user_notification_1" FOREIGN KEY ("noti_id") REFERENCES "notification" ("noti_id") ON DELETE NO ACTION ON UPDATE NO ACTION;
